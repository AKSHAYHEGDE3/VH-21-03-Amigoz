    ...
    <div>
       <nav style={{height:"15vh"}} class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div  class="container-fluid">
          <a style={{fontSize:"2rem",backgroundColor:"#d9d9d9",borderRadius:"15px"}} class="navbar-brand" href="#"><span style={{color:"black",paddingLeft:"10px"}}>Expense</span> <span style={{color:"#008037",paddingRight:"10px"}}>Analysis</span></a>
